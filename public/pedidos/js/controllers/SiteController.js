angular.module('napoles').controller('SiteController',['$scope','$http','$timeout','$window', function($scope, $http, $timeout, $window){
  ...
  $http.get('https://napoles-pizzaria.herokuapp.com/api/produtos/bairros?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg').then(function(bairros){
  ...
  // https://napoles-pizzaria.herokuapp.com/api/produtos/pizzasDoces?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg
  $http.get('https://napoles-pizzaria.herokuapp.com/api/produtos/pizzasDoces?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg').then(function(pizzasDoces){
  ...
  // https://napoles-pizzaria.herokuapp.com/api/produtos/esfihas?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg
  $http.get('https://napoles-pizzaria.herokuapp.com/api/produtos/esfihas?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg').then(function(esfihas){
  ...
  // https://napoles-pizzaria.herokuapp.com/api/produtos/esfihas?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg
  $http.get('https://napoles-pizzaria.herokuapp.com/api/produtos/esfihasDoces?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg').then(function(esfihas){
  ...
  // https://napoles-pizzaria.herokuapp.com/api/produtos/beirutes?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg
  $http.get('https://napoles-pizzaria.herokuapp.com/api/produtos/beirutes?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg').then(function(beirutes){
  ...
  // https://napoles-pizzaria.herokuapp.com/api/produtos/bebidas?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg
  $http.get('https://napoles-pizzaria.herokuapp.com/api/produtos/bebidas?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg').then(function(bebidas){
  ...
  // https://napoles-pizzaria.herokuapp.com/api/produtos/pagamentos?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg
  $http.get('https://napoles-pizzaria.herokuapp.com/api/produtos/pagamentos?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg').then(function(pagamentos){
  ...
  $http.get('https://napoles-pizzaria.herokuapp.com/api/produtos/bordas?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg').then(function(bordas){
  ...
  $scope.enviarPedido = function(form){
    ...
    $http.post('https://napoles-pizzaria.herokuapp.com/api/pedidos?token=eyJhbGciOiJIUzI1NiJ9.cGF1bG8.C2wuETOYPzALi8wHVI7Nk9c23AqFpu8-Q0BUe4SO7Jg', pedido).success(function(data, status){
      ...
      $timeout(function(){
       ...
       $scope.mensagem = 'Seu pedido foi enviado com sucesso, em caso de dúvidas entraremos em contato, caso contrário iremos entregar seu pedido dentro de 40min, obrigado ;)';
        $timeout(function(){
